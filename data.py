...
CLEANING_DETAILS = {
    'Ген.Уборка🧼': {
        'image_path': os.path.join(base_dir, 'img', 'general.png'),
        'details_text': [
            'Стоимость по тарифу "Генеральная уборка" расчитывается по 130р. за кв.М',
    ...
    'Повседневная🧹': {
        ...
        'details_text': [
            'Стоимость по тарифу "Повседневная уборка" расчитывается по 90р. за кв.М',
