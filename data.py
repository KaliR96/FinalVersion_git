...
CLEANING_DETAILS = {
    'Ген.Уборка🧼': {
        ...
        'details_text': [
            'Стоимость по тарифу "Генеральная уборка" рассчитывается по 125р. за кв.м.',
    ...
    'Повседневная🧹': {
        ...
        'details_text': [
            'Стоимость по тарифу "Повседневная уборка" рассчитывается по 75р. за кв.м.',
    ...
    'Мытье окон🧴': {
        ...
        'details_text': [
            'Стоимость по тарифу "Мытье окон" рассчитывается по 350р. за створку.',
